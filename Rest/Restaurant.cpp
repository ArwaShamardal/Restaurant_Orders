...
void Restaurant::OutputFile()
{
	...
	if (OutputFile.is_open())
	{
		...
		OutputFile << "cooks: " << Totalsize << "   " << "[Norm:" << sizeN << ", Veg:" << sizeG << ", VIP:" << sizeVIP << " injured:" << NumberOfInjuries << "]" << endl;
...
void Restaurant::AssignOrders(int timestep)     //c is the current timestep
{
	Cook* cook = nullptr;
	Order* order = nullptr;
